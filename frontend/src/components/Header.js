  ...
  return (
    <div className="header">
      <div className="header-fix">
        <div className="top1">
          <div className="get-app">
            <img src="images/get-app.png" height={20} /> Get App
          </div>
          <div className="icons">
            <img src="images/location.png" height={20} />
            Store & Events
          </div>
          <div className="icons">
            <img src="images/gift-card.png" height={20} />
            &nbsp; Gift Card
          </div>
          <div className="help">
            <img src="images/help.png" height={20} /> &nbsp; Help
          </div>
        </div>
        <div className="top2">
          <div className="items">
            <Link to="/">
              {" "}
              <img src="images/logo1.png" height={80} width={90}></img>
            </Link>
          </div>
          ...
          <Link to="/signin">
            <div className="account">
              {" "}
              <img src="images/user.png" height={25} /> &nbsp; <b>Account</b>
            </div>
          </Link>
          <Cart/>
        </div>
      ...
      <div className="top3">
        ...
        <div className="sale">
          <img src="images/sale.png" height={40} />
        </div>
      </div>
    </div>
  );
